package com.patientmanagement.stack;
...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService("AuthService",
                ...
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0ZXN0dXNlckBleGFtcGxlLmNvbSIsInJvbGUiOiJBRE1JTiIsImlhdCI6MTc3NzEyMjE1NywiZXhwIjoxNzc3MTU4MTU3fQ.HVyqvmI4vpG1PpnxfYm2j5u5xBLMDfETPepOx6FS-8Y"));
        ...
        FargateService patientService = createFargateService("PatientService",
                ...
                patientServiceDb,
                Map.of(
                        "BILLING_SERVICE_ADDRESS", "host.docker.interal",
                        "BILLING_SERVICE_GRCP_PORT", "9001"
                ));
    ...
    static void main(final String[] args) {
        // Create a CDK app with a custom output directory
        App app = new App(AppProps.builder().outdir("./cdk.out").build());

        // Define stack properties for LocalStack
        StackProps props = StackProps.builder()
            // LocalStack uses without bootstrap resources like account, region, etc.
            .synthesizer(new BootstraplessSynthesizer())
            .build();

        // Create an instance of the LocalStack stack
        new LocalStack(app, "localstack", props);
        // Synthesize the CloudFormation template for LocalStack
        app.synth();
